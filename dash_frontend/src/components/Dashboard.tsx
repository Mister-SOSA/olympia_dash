...
const masterWidgetList: Widget[] = [
    ...
    { id: "SalesByDayBar", x: 0, y: 2, w: 3, h: 3, enabled: true },
    { id: "SalesByMonthBar", x: 0, y: 0, w: 3, h: 3, enabled: true },
    { id: "SalesByMonthComparisonBar", x: 6, y: 8, w: 3, h: 3, enabled: false },
    { id: "ClockWidget", x: 0, y: 0, w: 6, h: 6, enabled: true },
    { id: "DateWidget", x: 0, y: 0, w: 6, h: 6, enabled: true },
    { id: "TopCustomersThisYearPie", x: 0, y: 0, w: 12, h: 6, enabled: true },
];
