...
export const WIDGET_CONFIGS: WidgetConfig[] = [
    ...
    // ─────────────────────────────────────────
    {
        id: "DateTimeWidget",
        title: "Date & Time",
        description: "Highly configurable clock and date display with digital/analog modes",
        category: "Utilities",
        subcategory: "Time",
        tags: ["clock", "time", "date", "calendar", "display", "analog", "digital"],
        defaultSize: { w: 3, h: 2 },
        minSize: { w: 2, h: 1 },
        searchKeywords: ["time", "clock", "date", "calendar", "timezone"],
    },
    {
        id: "Humidity",
        title: "Humidity",
...
export const WIDGET_COMPONENTS: Record<string, React.LazyExoticComponent<React.ComponentType<any>>> = {
    ...
    DateTimeWidget: React.lazy(() => import("./DateTimeWidget")),
